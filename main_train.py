...
def main():
    ...
    train_dataset = split_data[
        "train"
    ]

    val_dataset = split_data[
        "test"
    ]
    ...
    #
    # 8000  -> bpe_shared_8k
    # 16000 -> bpe_shared_16k
    # 32000 -> bpe_shared_32k

    BPE_MODEL_PREFIX = os.path.join(
        BPE_MODEL_DIR,
        f"bpe_shared_{BPE_VOCAB_SIZE // 1000}k"
    )
    ...
    if os.path.exists(
        ...
        print(
            f"BPE tokenizer with vocab size "
            f"{BPE_VOCAB_SIZE} not found."
        )
    ...
    experiment_config = {
        ...
        # New BPE experiment information
        "tokenizer_type":
            "sentencepiece_bpe",
